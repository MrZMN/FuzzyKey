...
int main(){
    ...
    //Randomly generate a n-bit nonce. Assume it's composed of all 1s.
    uint8_t nonce[k] = {31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31};
    ...
    //Sent in air
    uint8_t securesketch[n];

    //Encode the nonce to be a RS codeword
    encode_rs(securesketch, nonce);
