...
uint8_t tolerantflag = 1;   //flag that shows if the mismatches are within the error tolerance interval
...
//The RX of Improved Juels-Sudan construction of fuzzy vault
int main(){
