...
int main(){
    ...
    while(ite!= iterationtime * exectime){
        ...
        //Received from TX. This is an example (ps in TX comprise all 1s).
        int16_t securesketchTX[2*t+1] = {0, 19, 9};      //the received message contains the last 2*t elements only. The first element is 0 by default
